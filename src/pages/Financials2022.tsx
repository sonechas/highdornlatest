...
const Financials2022 = () => {
  ...
  const pdfDocuments = [
    {
      title: 'Financial Statements March 2022',
      file: '/2022 financials/Financial Statements March 22.pdf'
    },
    {
      title: 'Gender Pay Gap April 2022',
      file: '/2022 financials/Gender Pay Gap April 22.pdf'
    }
  ];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-20">
      ...
      <section className="py-20" style={{ backgroundColor: '#0f172a' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl font-bold mb-6" style={{ color: '#FFFFFF' }}>Financial Documents 2022</h1>

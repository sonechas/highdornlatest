...
const Financials2024 = () => {
  ...
  const pdfDocuments = [
    {
      title: 'Financial Statements March 2024',
      file: '/2024 financials/Financial Statements March 24.pdf'
    },
    {
      title: 'Gender Pay Gap April 2024',
      file: '/2024 financials/Gender Pay Gap April 24.pdf'
    }
  ];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-20">
      ...
      <section className="py-20" style={{ backgroundColor: '#0f172a' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl font-bold mb-6" style={{ color: '#FFFFFF' }}>Financial Documents 2024</h1>
